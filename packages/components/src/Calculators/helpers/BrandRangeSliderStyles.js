...
.rc-slider-track {
  ...
  height: 16px;
  border-radius: 6px;
  background: linear-gradient(90deg, var(--calc-track-start-color) 0.01%, var(--calc-track-end-color) 100%);
}
.rc-slider-handle {
  position: absolute;
  top: 10px;
...
.rc-slider-handle {
  ...
  ${({ isCurrencyBeforeAmount }) =>
    isCurrencyBeforeAmount ? 'flex-direction: row-reverse;' : null}
  ...
  &:before {
    ...
    padding: 3px;
    top: 13px;
    border: solid var(--calc-secondary-color);
